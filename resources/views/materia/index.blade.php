...
@section('content')
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header ">
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#crear_materia">
                                Nuevo
                              </button>
    ...
    @include('materia.modal-create')
    @include('materia.modal-edit')
@endsection
