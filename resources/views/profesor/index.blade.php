...
@section('content')
    ...
    @include('profesor.modal-create')
    @include('profesor.modal-edit')
@endsection
...
@section('scripts')
    ...
    <script>
        function getProfesor(profesores) {
            console.log(profesores);
            if (estado == 0) {
                $('#editar').slideDown('fast');
                $('#crear_nuevo').slideUp('fast');
            }
            $('#nombre').val(profesores.nombre);
            $('#apellido').val(profesores.apellido);
            $('#direccion').val(profesores.direccion);
            $('#telefono').val(profesores.telefono);

            $('#id').val(profesores.id);
        }
