...
@section('content')
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header ">
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#crear_alumno">
                                Nuevo
                            </button>
    ...
    @include('alumno.modal-create')
    @include('alumno.modal-edit')
@endsection
...
@section('scripts')
    ...
    <script>
        function getAlumno(alumnos) {
            console.log(alumnos);
            if (estado == 0) {
                $('#editar').slideDown('fast');
                $('#crear_nuevo').slideUp('fast');
            }
            $('#nombre').val(alumnos.nombre);
            $('#apellido').val(alumnos.apellido);
            $('#direccion').val(alumnos.direccion);
            $('#telefono').val(alumnos.telefono);
            $('#fecha_nacimiento').val(alumnos.fecha_nacimiento);
